...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops_azure_project-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-830292400663869.9.azuredatabricks.net/explore/data/models/staging/mlops_azure_project/mlops_azure_project-model)
* [Prod model in UC](https://adb-830292400663869.9.azuredatabricks.net/explore/data/models/prod/mlops_azure_project/mlops_azure_project-model)
. 
